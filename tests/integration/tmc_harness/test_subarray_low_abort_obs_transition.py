...
class TestSubarrayNodeLowAbortCommandObsStateTransitions(object):
    @pytest.mark.parametrize(
        "source_obs_state",
        ["IDLE", "READY", "SCANNING", "RESOURCING", "CONFIGURING"],
    )
    ...
    def test_subarray_obs_transitions_valid_data(
        ...
        subarray_node_low.force_change_of_obs_state(source_obs_state)
        ...
        subarray_node_low.execute_transition("Abort", argin=None)
