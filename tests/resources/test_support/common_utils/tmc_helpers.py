...
from tests.resources.test_support.constant import (
    DEVICE_OBS_STATE_ABORT_INFO as MID_ABORT_INFO,
)
from tests.resources.test_support.constant import (
    DEVICE_OBS_STATE_EMPTY_INFO as MID_EMPTY_INFO,
)
from tests.resources.test_support.constant import (
    DEVICE_OBS_STATE_IDLE_INFO as MID_IDLE_INFO,
)
from tests.resources.test_support.constant import (
    DEVICE_STATE_STANDBY_INFO as MID_STANDBY_INFO,
)
from tests.resources.test_support.constant_low import (
    DEVICE_OBS_STATE_ABORT_INFO as LOW_ABORT_INFO,
)
from tests.resources.test_support.constant_low import (
    DEVICE_OBS_STATE_EMPTY_INFO as LOW_EMPTY_INFO,
)
from tests.resources.test_support.constant_low import (
    DEVICE_OBS_STATE_IDLE_INFO as LOW_IDLE_INFO,
)
from tests.resources.test_support.constant_low import (
...
def tear_down(
    ...
    **kwargs,
    ...
    if "mid" in kwargs.get("tmc_subarraynode"):
        ABORT_INFO = MID_ABORT_INFO
        EMPTY_INFO = MID_EMPTY_INFO
        IDLE_INFO = MID_IDLE_INFO
        STANDBY_INFO = MID_STANDBY_INFO
    else:
        ABORT_INFO = LOW_ABORT_INFO
        EMPTY_INFO = LOW_EMPTY_INFO
        IDLE_INFO = LOW_IDLE_INFO
        STANDBY_INFO = LOW_STANDBY_INFO
