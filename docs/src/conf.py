...
intersphinx_mapping = {
    ...
    "ska-tmc-cdm": ("https://developer.skao.int/projects/ska-tmc-cdm/en/latest", None),
    "ska-oso-pdm": ("https://developer.skao.int/projects/ska-oso-pdm/en/latest/", None),
    "ska-oso-oet": ("https://developer.skao.int/projects/ska-oso-oet/en/latest", None),
}
